...
### output format :
   ...
   ![image](https://github.com/katelo731/DM_FinalProject/blob/master/sudoku.PNG)![image](https://github.com/katelo731/DM_FinalProject/blob/master/sudoku.PNG)
   
    green number is the answer to the sudoku,
    white number is the input number. 
